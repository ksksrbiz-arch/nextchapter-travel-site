...
export function MemoryArchivesSkeleton() {
  return (
    <div className="space-y-4 animate-pulse">
      <div className="h-10 w-56 bg-gray-200 dark:bg-gray-700 rounded-lg" />
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        {[...Array(4)].map((_, i) => (
          <div
            key={i}
            className="h-44 rounded-2xl bg-gray-100 dark:bg-gray-800"
          />
        ))}
      </div>
    </div>
...
export function BusinessOperationsSkeleton() {
  return (
    <div className="space-y-5 animate-pulse">
      <div className="h-10 w-72 bg-gray-200 dark:bg-gray-700 rounded-lg" />
      <div className="h-12 w-full max-w-md bg-gray-100 dark:bg-gray-800 rounded-xl" />
